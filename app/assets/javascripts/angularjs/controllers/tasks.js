tasksApp.controller("tasksIndexCtrl" , [ "$scope" , "$http" , function($scope , $http){
    (function(){
...
controller("tasksNewCtrl" , [ "$scope" , "$http" , "$window" , "$rootScope" , function($scope , $http , $window , $rootScope){
    $scope.new_task = {};
    ...
    $scope.submit = function(){
        ...
        success(function(data , a , b, c){
            ...
            console.log(b);
            console.log(c);
            $rootScope.alert.success.push("Made a new task!");
        }).
...
controller("tasksViewCtrl" , ["$scope" , "$http" , "$routeParams" ,function($scope , $http , $routeParams){
    (function(){
        $scope.task = {};
